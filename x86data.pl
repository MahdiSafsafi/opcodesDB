...
#
# FPU_TOP = N. Instruction increment top register by N time (N could be negative = decrement).
#
...
# TODO
# ----
# - Fix xchg instructions.
# - Add instructions aliases.

# Last modification = 18:42:47 01 Mar 2017  
...
@instructions = (
  ...
  ['adc'           , 'ax, imm16'                    , 'i:       66 15 iw                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'eax, imm32'                   , 'i:       15 id                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'rax, imm32'                   , 'x64:i:   rex.w 15 id                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m8, imm8'                   , 'mi:      80 /2 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m16, imm16'                 , 'mi:      66 81 /2 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m32, imm32'                 , 'mi:      81 /2 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /2 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m16, imm8'                  , 'mi:      66 83 /2 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m32, imm8'                  , 'mi:      83 /2 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /2 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m8, r8'                     , 'mr:      10 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m16, r16'                   , 'mr:      66 11 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m32, r32'                   , 'mr:      11 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 11 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r8, r/m8'                     , 'rm:      12 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r16, r/m16'                   , 'rm:      66 13 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r32, r/m32'                   , 'rm:      13 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['adc'           , 'r64, r/m64'                   , 'x64:rm:  rex.w 13 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],

  ['adcx'          , 'r32, r/m32'                   , 'rm:      66 0f 38 f6 /r                ' , 'CPUID=ADX OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['adcx'          , 'r64, r/m64'                   , 'x64:rm:  66 rex.w 0f 38 f6 /r          ' , 'CPUID=ADX OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],

  ['add'           , 'al, imm8'                     , 'i:       04 ib                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'ax, imm16'                    , 'i:       66 05 iw                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'eax, imm32'                   , 'i:       05 id                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'rax, imm32'                   , 'x64:i:   rex.w 05 id                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m8, imm8'                   , 'mi:      80 /0 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m16, imm16'                 , 'mi:      66 81 /0 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m32, imm32'                 , 'mi:      81 /0 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /0 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m16, imm8'                  , 'mi:      66 83 /0 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m32, imm8'                  , 'mi:      83 /0 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /0 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m8, r8'                     , 'mr:      00 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m16, r16'                   , 'mr:      66 01 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m32, r32'                   , 'mr:      01 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 01 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r8, r/m8'                     , 'rm:      02 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r16, r/m16'                   , 'rm:      66 03 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r32, r/m32'                   , 'rm:      03 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['add'           , 'r64, r/m64'                   , 'x64:rm:  rex.w 03 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ...
  ['adox'          , 'r32, r/m32'                   , 'rm:      f3 0f 38 f6 /r                ' , 'CPUID=ADX OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['adox'          , 'r64, r/m64'                   , 'x64:rm:  f3 rex.w 0f 38 f6 /r          ' , 'CPUID=ADX OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ...
  ['and'           , 'ax, imm16'                    , 'i:       66 25 iw                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'eax, imm32'                   , 'i:       25 id                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'rax, imm32'                   , 'x64:i:   rex.w 25 id                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m8, imm8'                   , 'mi:      80 /4 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m16, imm16'                 , 'mi:      66 81 /4 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m32, imm32'                 , 'mi:      81 /4 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /4 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m16, imm8'                  , 'mi:      66 83 /4 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m32, imm8'                  , 'mi:      83 /4 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /4 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m8, r8'                     , 'mr:      20 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m16, r16'                   , 'mr:      66 21 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m32, r32'                   , 'mr:      21 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 21 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r8, r/m8'                     , 'rm:      22 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r16, r/m16'                   , 'rm:      66 23 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r32, r/m32'                   , 'rm:      23 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['and'           , 'r64, r/m64'                   , 'x64:rm:  rex.w 23 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ...
  ['bound'         , 'R:r16, m16&16'                , 'x86:rm:  66 62 /r                      ' , ''],
  ['bound'         , 'R:r32, m32&32'                , 'x86:rm:  62 /r                         ' , ''],

  ['bsf'           , 'W:r16, r/m16'                 , 'rm:      66 0f bc /r                   ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],
  ['bsf'           , 'W:r32, r/m32'                 , 'rm:      0f bc /r                      ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],
  ['bsf'           , 'W:r64, r/m64'                 , 'x64:rm:  rex.w 0f bc /r                ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],

  ['bsr'           , 'W:r16, r/m16'                 , 'rm:      66 0f bd /r                   ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],
  ['bsr'           , 'W:r32, r/m32'                 , 'rm:      0f bd /r                      ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],
  ['bsr'           , 'W:r64, r/m64'                 , 'x64:rm:  rex.w 0f bd /r                ' , 'OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=U'],

  ['bswap'         , 'r32'                          , 'o:      0f c8+rd                      ' , ''],
  ['bswap'         , 'r64'                          , 'x64:o:  rex.w 0f c8+rd                ' , ''],

  ['bt'            , 'R:r/m16, r16'                 , 'mr:      66 0f a3 /r                   ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bt'            , 'R:r/m32, r32'                 , 'mr:      0f a3 /r                      ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bt'            , 'R:r/m64, r64'                 , 'x64:mr:  rex.w 0f a3 /r                ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bt'            , 'R:r/m16, imm8'                , 'mi:      66 0f ba /4 ib                ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bt'            , 'R:r/m32, imm8'                , 'mi:      0f ba /4 ib                   ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bt'            , 'R:r/m64, imm8'                , 'x64:mi:  rex.w 0f ba /4 ib             ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],

  ['btc'           , 'r/m16, r16'                   , 'mr:      66 0f bb /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btc'           , 'r/m32, r32'                   , 'mr:      0f bb /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btc'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 0f bb /r                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btc'           , 'r/m16, imm8'                  , 'mi:      66 0f ba /7 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btc'           , 'r/m32, imm8'                  , 'mi:      0f ba /7 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btc'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 0f ba /7 ib             ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],

  ['btr'           , 'r/m16, r16'                   , 'mr:      66 0f b3 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btr'           , 'r/m32, r32'                   , 'mr:      0f b3 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btr'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 0f b3 /r                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btr'           , 'r/m16, imm8'                  , 'mi:      66 0f ba /6 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btr'           , 'r/m32, imm8'                  , 'mi:      0f ba /6 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['btr'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 0f ba /6 ib             ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],

  ['bts'           , 'r/m16, r16'                   , 'mr:      66 0f ab /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bts'           , 'r/m32, r32'                   , 'mr:      0f ab /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bts'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 0f ab /r                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bts'           , 'r/m16, imm8'                  , 'mi:      66 0f ba /5 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bts'           , 'r/m32, imm8'                  , 'mi:      0f ba /5 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['bts'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 0f ba /5 ib             ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ...
  ['call'          , 'rel16'                        , 'x86:m:  e8 ow                         ' , 'NEAR BND'],
  ['call'          , 'rel32'                        , 'm:      e8 od                         ' , 'NEAR BND'],
  ['call'          , 'R:r/m16'                      , 'x86:m:  66 ff /2                      ' , 'NEAR BND'],
  ['call'          , 'R:r/m32'                      , 'x86:m:  ff /2                         ' , 'NEAR BND'],
  ['call'          , 'R:r/m64'                      , 'x64:m:  ff /2                         ' , 'NEAR BND'],
  ['call'          , 'ptr16:16'                     , 'x86:d:  66 9a od                      ' , 'FAR'],
  ['call'          , 'ptr16:32'                     , 'x86:d:  9a op                         ' , 'FAR'],
  ['call'          , 'm16:16'                       , 'm:      66 ff /3                      ' , 'FAR'],
  ['call'          , 'm16:32'                       , 'm:      ff /3                         ' , 'FAR'],
  ['call'          , 'm16:64'                       , 'x64:m:  rex.w ff /3                   ' , 'FAR'],

  ['cbw'           , 'R:<ax>'                       , '      66 98                         ' , ''],
  ['cwde'          , 'R:<eax>'                      , '      98                            ' , ''],
  ['cdqe'          , 'R:<rax>'                      , 'x64:  rex.w 98                      ' , ''],
  ...
  ['cmova'         , 'r16, r/m16'                   , 'rm:      66 0f 47 /r                   ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmova'         , 'r32, r/m32'                   , 'rm:      0f 47 /r                      ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmova'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 47 /r                ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovae'        , 'r16, r/m16'                   , 'rm:      66 0f 43 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovae'        , 'r32, r/m32'                   , 'rm:      0f 43 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovae'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 43 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmovb'         , 'r16, r/m16'                   , 'rm:      66 0f 42 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovb'         , 'r32, r/m32'                   , 'rm:      0f 42 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovb'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 42 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmovbe'        , 'r16, r/m16'                   , 'rm:      66 0f 46 /r                   ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovbe'        , 'r32, r/m32'                   , 'rm:      0f 46 /r                      ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovbe'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 46 /r                ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovc'         , 'r16, r/m16'                   , 'rm:      66 0f 42 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovc'         , 'r32, r/m32'                   , 'rm:      0f 42 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovc'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 42 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmove'         , 'r16, r/m16'                   , 'rm:      66 0f 44 /r                   ' , 'CPUID=CMOV ZF=T'],
  ['cmove'         , 'r32, r/m32'                   , 'rm:      0f 44 /r                      ' , 'CPUID=CMOV ZF=T'],
  ['cmove'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 44 /r                ' , 'CPUID=CMOV ZF=T'],
  ['cmovg'         , 'r16, r/m16'                   , 'rm:      66 0f 4f /r                   ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovg'         , 'r32, r/m32'                   , 'rm:      0f 4f /r                      ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovg'         , 'r64, r/m64'                   , 'x86:rm:  rex.w 0f 4f /r                ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovge'        , 'r16, r/m16'                   , 'rm:      66 0f 4d /r                   ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovge'        , 'r32, r/m32'                   , 'rm:      0f 4d /r                      ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovge'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4d /r                ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovl'         , 'r16, r/m16'                   , 'rm:      66 0f 4c /r                   ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovl'         , 'r32, r/m32'                   , 'rm:      0f 4c /r                      ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovl'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4c /r                ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovle'        , 'r16, r/m16'                   , 'rm:      66 0f 4e /r                   ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovle'        , 'r32, r/m32'                   , 'rm:      0f 4e /r                      ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovle'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4e /r                ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovna'        , 'r16, r/m16'                   , 'rm:      66 0f 46 /r                   ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovna'        , 'r32, r/m32'                   , 'rm:      0f 46 /r                      ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovna'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 46 /r                ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovnae'       , 'r16, r/m16'                   , 'rm:      66 0f 42 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovnae'       , 'r32, r/m32'                   , 'rm:      0f 42 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovnae'       , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 42 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmovnb'        , 'r16, r/m16'                   , 'rm:      66 0f 43 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovnb'        , 'r32, r/m32'                   , 'rm:      0f 43 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovnb'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 43 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmovnbe'       , 'r16, r/m16'                   , 'rm:      66 0f 47 /r                   ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovnbe'       , 'r32, r/m32'                   , 'rm:      0f 47 /r                      ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovnbe'       , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 47 /r                ' , 'CPUID=CMOV CF=T ZF=T'],
  ['cmovnc'        , 'r16, r/m16'                   , 'rm:      66 0f 43 /r                   ' , 'CPUID=CMOV CF=T'],
  ['cmovnc'        , 'r32, r/m32'                   , 'rm:      0f 43 /r                      ' , 'CPUID=CMOV CF=T'],
  ['cmovnc'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 43 /r                ' , 'CPUID=CMOV CF=T'],
  ['cmovne'        , 'r16, r/m16'                   , 'rm:      66 0f 45 /r                   ' , 'CPUID=CMOV ZF=T'],
  ['cmovne'        , 'r32, r/m32'                   , 'rm:      0f 45 /r                      ' , 'CPUID=CMOV ZF=T'],
  ['cmovne'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 45 /r                ' , 'CPUID=CMOV ZF=T'],
  ['cmovng'        , 'r16, r/m16'                   , 'rm:      66 0f 4e /r                   ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovng'        , 'r32, r/m32'                   , 'rm:      0f 4e /r                      ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovng'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4e /r                ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovnge'       , 'r16, r/m16'                   , 'rm:      66 0f 4c /r                   ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnge'       , 'r32, r/m32'                   , 'rm:      0f 4c /r                      ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnge'       , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4c /r                ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnl'        , 'r16, r/m16'                   , 'rm:      66 0f 4d /r                   ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnl'        , 'r32, r/m32'                   , 'rm:      0f 4d /r                      ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnl'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4d /r                ' , 'CPUID=CMOV FLAGS.SF=T OF=T'],
  ['cmovnle'       , 'r16, r/m16'                   , 'rm:      66 0f 4f /r                   ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovnle'       , 'r32, r/m32'                   , 'rm:      0f 4f /r                      ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovnle'       , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4f /r                ' , 'CPUID=CMOV ZF=T FLAGS.SF=T OF=T'],
  ['cmovno'        , 'r16, r/m16'                   , 'rm:      66 0f 41 /r                   ' , 'CPUID=CMOV OF=T'],
  ['cmovno'        , 'r32, r/m32'                   , 'rm:      0f 41 /r                      ' , 'CPUID=CMOV OF=T'],
  ['cmovno'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 41 /r                ' , 'CPUID=CMOV OF=T'],
  ['cmovnp'        , 'r16, r/m16'                   , 'rm:      66 0f 4b /r                   ' , 'CPUID=CMOV PF=T'],
  ['cmovnp'        , 'r32, r/m32'                   , 'rm:      0f 4b /r                      ' , 'CPUID=CMOV PF=T'],
  ['cmovnp'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4b /r                ' , 'CPUID=CMOV PF=T'],
  ['cmovns'        , 'r16, r/m16'                   , 'rm:      66 0f 49 /r                   ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovns'        , 'r32, r/m32'                   , 'rm:      0f 49 /r                      ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovns'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 49 /r                ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovnz'        , 'r16, r/m16'                   , 'rm:      66 0f 45 /r                   ' , 'CPUID=CMOV ZF=T'],
  ['cmovnz'        , 'r32, r/m32'                   , 'rm:      0f 45 /r                      ' , 'CPUID=CMOV ZF=T'],
  ['cmovnz'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 45 /r                ' , 'CPUID=CMOV ZF=T'],
  ['cmovo'         , 'r16, r/m16'                   , 'rm:      66 0f 40 /r                   ' , 'CPUID=CMOV OF=T'],
  ['cmovo'         , 'r32, r/m32'                   , 'rm:      0f 40 /r                      ' , 'CPUID=CMOV OF=T'],
  ['cmovo'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 40 /r                ' , 'CPUID=CMOV OF=T'],
  ['cmovp'         , 'r16, r/m16'                   , 'rm:      66 0f 4a /r                   ' , 'CPUID=CMOV PF=T'],
  ['cmovp'         , 'r32, r/m32'                   , 'rm:      0f 4a /r                      ' , 'CPUID=CMOV PF=T'],
  ['cmovp'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4a /r                ' , 'CPUID=CMOV PF=T'],
  ['cmovpe'        , 'r16, r/m16'                   , 'rm:      66 0f 4a /r                   ' , 'CPUID=CMOV PF=T'],
  ['cmovpe'        , 'r32, r/m32'                   , 'rm:      0f 4a /r                      ' , 'CPUID=CMOV PF=T'],
  ['cmovpe'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4a /r                ' , 'CPUID=CMOV PF=T'],
  ['cmovpo'        , 'r16, r/m16'                   , 'rm:      66 0f 4b /r                   ' , 'CPUID=CMOV PF=T'],
  ['cmovpo'        , 'r32, r/m32'                   , 'rm:      0f 4b /r                      ' , 'CPUID=CMOV PF=T'],
  ['cmovpo'        , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 4b /r                ' , 'CPUID=CMOV PF=T'],
  ['cmovs'         , 'r16, r/m16'                   , 'rm:      66 0f 48 /r                   ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovs'         , 'r32, r/m32'                   , 'rm:      0f 48 /r                      ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovs'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 48 /r                ' , 'CPUID=CMOV FLAGS.SF=T'],
  ['cmovz'         , 'r16, r/m16'                   , 'rm:      66 0f 44 /r                   ' , 'CPUID=CMOV ZF=T'],
  ['cmovz'         , 'r32, r/m32'                   , 'rm:      0f 44 /r                      ' , 'CPUID=CMOV ZF=T'],
  ['cmovz'         , 'r64, r/m64'                   , 'x64:rm:  rex.w 0f 44 /r                ' , 'CPUID=CMOV ZF=T'],

  ['cmp'           , 'R:al, imm8'                   , 'i:       3c ib                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:ax, imm16'                  , 'i:       66 3d iw                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:eax, imm32'                 , 'i:       3d id                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:rax, imm32'                 , 'x64:i:   rex.w 3d id                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m8, imm8'                 , 'mi:      80 /7 ib                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m16, imm16'               , 'mi:      66 81 /7 iw                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m32, imm32'               , 'mi:      81 /7 id                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m64, imm32'               , 'x64:mi:  rex.w 81 /7 id                ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m16, imm8'                , 'mi:      66 83 /7 ib                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m32, imm8'                , 'mi:      83 /7 ib                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m64, imm8'                , 'x64:mi:  rex.w 83 /7 ib                ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m8, r8'                   , 'mr:      38 /r                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m16, r16'                 , 'mr:      66 39 /r                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m32, r32'                 , 'mr:      39 /r                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r/m64, r64'                 , 'x64:mr:  rex.w 39 /r                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r8, r/m8'                   , 'rm:      3a /r                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r16, r/m16'                 , 'rm:      66 3b /r                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r32, r/m32'                 , 'rm:      3b /r                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmp'           , 'R:r64, r/m64'                 , 'x64:rm:  rex.w 3b /r                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ...
  ['cmpsw'         , 'R:<[ds:*si]>, <[*di]>'        , '      66 a7                         ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmpsd'         , 'R:<[ds:*si]>, <[*di]>'        , '      a7                            ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmpsq'         , 'R:<[*si]>, <[*di]>'           , 'x64:  rex.w a7                      ' , 'REPE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ...
  ['cmpxchg'       , 'r/m16, r16, <ax>'             , 'mr:      66 0f b1 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmpxchg'       , 'r/m32, r32, <eax>'            , 'mr:      0f b1 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['cmpxchg'       , 'r/m64, r64, <rax>'            , 'x64:mr:  rex.w 0f b1 /r                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],

  ['cmpxchg8b'     , 'm64, X:<edx>, X:<eax>, W:<ecx>, W:<ebx>'  , 'm:      0f c7 /1                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT CPUID=CMPXCHG16B ZF=M'],
  ['cmpxchg16b'    , 'm128, X:<rdx>, X:<rax>, W:<rcx>, W:<rbx>' , 'x64:m:  rex.w 0f c7 /1                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT CPUID=CMPXCHG16B ZF=M'],
  ...
  ['crc32'         , 'r32, r/m16'                   , 'rm:      66 f2 0f 38 f1 /r             ' , 'CPUID=SSE4v2'],
  ['crc32'         , 'r32, r/m32'                   , 'rm:      f2 0f 38 f1 /r                ' , 'CPUID=SSE4v2'],
  ['crc32'         , 'r64, r/m8'                    , 'x64:rm:  f2 rex.w 0f 38 f0 /r          ' , 'CPUID=SSE4v2'],
  ['crc32'         , 'r64, r/m64'                   , 'x64:rm:  f2 rex.w 0f 38 f1 /r          ' , 'CPUID=SSE4v2'],
  ...
  ['dec'           , 'r/m16'                        , 'm:      66 ff /1                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['dec'           , 'r/m32'                        , 'm:      ff /1                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['dec'           , 'r/m64'                        , 'x64:m:  rex.w ff /1                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['dec'           , 'r16'                          , 'x86:o:  48+rw                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['dec'           , 'r32'                          , 'x86:o:  48+rd                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M'],

  ['div'           , 'W:r/m8, X:<ax>'               , 'm:      f6 /6                         ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ['div'           , 'W:r/m16, X:<dx>, X:<ax>'      , 'm:      66 f7 /6                      ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ['div'           , 'W:r/m32, X:<edx>, X:<eax>'    , 'm:      f7 /6                         ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ['div'           , 'W:r/m64, X:<rdx>, X:<rax>'    , 'x64:m:  rex.w f7 /6                   ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ...
  ['fxrstor'       , 'R:m512'                       , 'm:      0f ae /1                      ' , 'CPUID=FXSR|FPU'],
  ['fxrstor64'     , 'R:m512'                       , 'x64:m:  rex.w 0f ae /1                ' , 'CPUID=FXSR|FPU'],

  ['fxsave'        , 'W:m512'                       , 'm:      0f ae /0                      ' , 'CPUID=FXSR|FPU'],
  ['fxsave64'      , 'W:m512'                       , 'x64:m:  rex.w 0f ae /0                ' , 'CPUID=FXSR|FPU'],
  ...
  ['idiv'          , 'R:r/m16, X:<dx>, X:<ax>'      , 'm:      66 f7 /7                      ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ['idiv'          , 'R:r/m32, X:<edx>, X:<eax>'    , 'm:      f7 /7                         ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],
  ['idiv'          , 'R:r/m64, X:<rdx>, X:<rax>'    , 'x64:m:  rex.w f7 /7                   ' , 'OF=U FLAGS.SF=U ZF=U AF=U PF=U CF=U'],

  ['imul'          , 'r/m8, X:<ax>'                 , 'm:        f6 /5                         ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r/m16, W:<dx>, X:<ax>'        , 'm:        66 f7 /5                      ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r/m32, W:<edx>, X:<eax>'      , 'm:        f7 /5                         ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r/m64, W:<rdx>, X:<rax>'      , 'x64:m:    rex.w f7 /5                   ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r16, r/m16'                   , 'rm:       66 0f af /r                   ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r32, r/m32'                   , 'rm:       0f af /r                      ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r64, r/m64'                   , 'x64:rm:   rex.w 0f af /r                ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r16, r/m16, imm8'             , 'rmi:      66 6b /r ib                   ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r32, r/m32, imm8'             , 'rmi:      6b /r ib                      ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r64, r/m64, imm8'             , 'x64:rmi:  rex.w 6b /r ib                ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r16, r/m16, imm16'            , 'rmi:      66 69 /r iw                   ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r32, r/m32, imm32'            , 'rmi:      69 /r id                      ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['imul'          , 'r64, r/m64, imm32'            , 'x64:rmi:  rex.w 69 /r id                ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],

  ['in'            , 'al, imm8'                     , 'i:  e4 ib                         ' , ''],
  ['in'            , 'ax, imm8'                     , 'i:  66 e5 ib                      ' , ''],
  ['in'            , 'eax, imm8'                    , 'i:  e5 ib                         ' , ''],
  ['in'            , 'al, dx'                       , '    ec                            ' , ''],
  ['in'            , 'ax, dx'                       , '    66 ed                         ' , ''],
  ['in'            , 'eax, dx'                      , '    ed                            ' , ''],
  ...
  ['inc'           , 'r/m16'                        , 'm:      66 ff /0                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['inc'           , 'r/m32'                        , 'm:      ff /0                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['inc'           , 'r/m64'                        , 'x64:m:  rex.w ff /0                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['inc'           , 'r16'                          , 'x86:o:  40+rw                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M'],
  ['inc'           , 'r32'                          , 'x86:o:  40+rd                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M'],

  ['insb'          , 'W:<[es:*di]>, <dx>'           , '  6c                            ' , 'REP'],
  ['insw'          , 'W:<[es:*di]>, <dx>'           , '  66 6d                         ' , 'REP'],
  ['insd'          , 'W:<[es:*di]>, <dx>'           , '  6d                            ' , 'REP'],
  ...
  ['iret'          , ''                             , '      cf                            ' , 'OF=P FLAGS.SF=P ZF=P AF=P PF=P CF=P TF=P IF=P DF=P NT=T'],
  ['iretd'         , ''                             , '      cf                            ' , ''],
  ['iretq'         , ''                             , 'x64:  rex.w cf                      ' , ''],
  ...
  ['jc'            , 'rel8'                         , 'd:      72 ob                         ' , 'SHORT BND CF=T'],
  ['jcxz'          , 'rel8'                         , 'x86:d:  e3 ob                         ' , 'SHORT'],
  ['jecxz'         , 'rel8'                         , 'd:      e3 ob                         ' , 'SHORT'],
  ['jrcxz'         , 'rel8'                         , 'x64:d:  e3 ob                         ' , 'SHORT'],
  ...
  ['jna'           , 'rel8'                         , 'd:      76 ob                         ' , 'SHORT BND CF=T ZF=T'],
  ['jnae'          , 'rel8'                         , 'd:      72 ob                         ' , 'SHORT BND CF=T'],
  ['jnb'           , 'rel8'                         , 'd:      73 ob                         ' , 'SHORT BND CF=T'],
  ['jnbe'          , 'rel8'                         , 'd:      77 ob                         ' , 'SHORT BND CF=T ZF=T'],
  ['jnc'           , 'rel8'                         , 'd:      73 ob                         ' , 'SHORT BND CF=T'],
  ['jne'           , 'rel8'                         , 'd:      75 ob                         ' , 'SHORT BND ZF=T'],
  ['jng'           , 'rel8'                         , 'd:      7e ob                         ' , 'SHORT BND ZF=T FLAGS.SF=T OF=T'],
  ['jnge'          , 'rel8'                         , 'd:      7c ob                         ' , 'SHORT BND FLAGS.SF=T OF=T'],
  ['jnl'           , 'rel8'                         , 'd:      7d ob                         ' , 'SHORT BND FLAGS.SF=T OF=T'],
  ['jnle'          , 'rel8'                         , 'd:      7f ob                         ' , 'SHORT BND ZF=T FLAGS.SF=T OF=T'],
  ['jno'           , 'rel8'                         , 'd:      71 ob                         ' , 'SHORT BND OF=T'],
  ['jnp'           , 'rel8'                         , 'd:      7b ob                         ' , 'SHORT BND PF=T'],
  ['jns'           , 'rel8'                         , 'd:      79 ob                         ' , 'SHORT BND FLAGS.SF=T'],
  ['jnz'           , 'rel8'                         , 'd:      75 ob                         ' , 'SHORT BND ZF=T'],
  ['jo'            , 'rel8'                         , 'd:      70 ob                         ' , 'SHORT BND OF=T'],
  ['jp'            , 'rel8'                         , 'd:      7a ob                         ' , 'SHORT BND PF=T'],
  ['jpe'           , 'rel8'                         , 'd:      7a ob                         ' , 'SHORT BND PF=T'],
  ['jpo'           , 'rel8'                         , 'd:      7b ob                         ' , 'SHORT BND PF=T'],
  ['js'            , 'rel8'                         , 'd:      78 ob                         ' , 'SHORT BND FLAGS.SF=T'],
  ['jz'            , 'rel8'                         , 'd:      74 ob                         ' , 'SHORT BND ZF=T'],
  ['ja'            , 'rel16'                        , 'x86:d:  66 0f 87 ow                   ' , 'NEAR BND CF=T ZF=T'],
  ['ja'            , 'rel32'                        , 'd:      0f 87 od                      ' , 'NEAR BND CF=T ZF=T'],
  ['jae'           , 'rel16'                        , 'x86:d:  66 0f 83 ow                   ' , 'NEAR BND CF=T'],
  ['jae'           , 'rel32'                        , 'd:      0f 83 od                      ' , 'NEAR BND CF=T'],
  ['jb'            , 'rel16'                        , 'x86:d:  66 0f 82 ow                   ' , 'NEAR BND CF=T'],
  ['jb'            , 'rel32'                        , 'd:      0f 82 od                      ' , 'NEAR BND CF=T'],
  ['jbe'           , 'rel16'                        , 'x86:d:  66 0f 86 ow                   ' , 'NEAR BND CF=T ZF=T'],
  ['jbe'           , 'rel32'                        , 'd:      0f 86 od                      ' , 'NEAR BND CF=T ZF=T'],
  ['jc'            , 'rel16'                        , 'x86:d:  66 0f 82 ow                   ' , 'NEAR BND CF=T'],
  ['jc'            , 'rel32'                        , 'd:      0f 82 od                      ' , 'NEAR BND CF=T'],
  ['je'            , 'rel16'                        , 'x86:d:  66 0f 84 ow                   ' , 'NEAR BND ZF=T'],
  ['je'            , 'rel32'                        , 'd:      0f 84 od                      ' , 'NEAR BND ZF=T'],
  ['jz'            , 'rel16'                        , 'x86:d:  66 0f 84 ow                   ' , 'NEAR BND ZF=T'],
  ['jz'            , 'rel32'                        , 'd:      0f 84 od                      ' , 'NEAR BND ZF=T'],
  ['jg'            , 'rel16'                        , 'x86:d:  66 0f 8f ow                   ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jg'            , 'rel32'                        , 'd:      0f 8f od                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jge'           , 'rel16'                        , 'x86:d:  66 0f 8d ow                   ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jge'           , 'rel32'                        , 'd:      0f 8d od                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jl'            , 'rel16'                        , 'x86:d:  66 0f 8c ow                   ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jl'            , 'rel32'                        , 'd:      0f 8c od                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jle'           , 'rel16'                        , 'x86:d:  66 0f 8e ow                   ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jle'           , 'rel32'                        , 'd:      0f 8e od                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jna'           , 'rel16'                        , 'x86:d:  0f 86 ow                      ' , 'NEAR BND CF=T ZF=T'],
  ['jna'           , 'rel32'                        , 'd:      0f 86 od                      ' , 'NEAR BND CF=T ZF=T'],
  ['jnae'          , 'rel16'                        , 'x86:d:  0f 82 ow                      ' , 'NEAR BND CF=T'],
  ['jnae'          , 'rel32'                        , 'd:      0f 82 od                      ' , 'NEAR BND CF=T'],
  ['jnb'           , 'rel16'                        , 'x86:d:  66 0f 83 ow                   ' , 'NEAR BND CF=T'],
  ['jnb'           , 'rel32'                        , 'd:      0f 83 od                      ' , 'NEAR BND CF=T'],
  ['jnbe'          , 'rel16'                        , 'x86:d:  0f 87 ow                      ' , 'NEAR BND CF=T ZF=T'],
  ['jnbe'          , 'rel32'                        , 'd:      0f 87 od                      ' , 'NEAR BND CF=T ZF=T'],
  ['jnc'           , 'rel16'                        , 'x86:d:  0f 83 ow                      ' , 'NEAR BND CF=T'],
  ['jnc'           , 'rel32'                        , 'd:      0f 83 od                      ' , 'NEAR BND CF=T'],
  ['jne'           , 'rel16'                        , 'x86:d:  66 0f 85 ow                   ' , 'NEAR BND ZF=T'],
  ['jne'           , 'rel32'                        , 'd:      0f 85 od                      ' , 'NEAR BND ZF=T'],
  ['jng'           , 'rel16'                        , 'x86:d:  0f 8e ow                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jng'           , 'rel32'                        , 'd:      0f 8e od                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jnge'          , 'rel16'                        , 'x86:d:  0f 8c ow                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jnge'          , 'rel32'                        , 'd:      0f 8c od                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jnl'           , 'rel16'                        , 'x86:d:  0f 8d ow                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jnl'           , 'rel32'                        , 'd:      0f 8d od                      ' , 'NEAR BND FLAGS.SF=T OF=T'],
  ['jnle'          , 'rel16'                        , 'x86:d:  0f 8f ow                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jnle'          , 'rel32'                        , 'd:      0f 8f od                      ' , 'NEAR BND ZF=T FLAGS.SF=T OF=T'],
  ['jno'           , 'rel16'                        , 'x86:d:  0f 81 ow                      ' , 'NEAR BND OF=T'],
  ['jno'           , 'rel32'                        , 'd:      0f 81 od                      ' , 'NEAR BND OF=T'],
  ['jnp'           , 'rel16'                        , 'x86:d:  66 0f 8b ow                   ' , 'NEAR BND PF=T'],
  ['jnp'           , 'rel32'                        , 'd:      0f 8b od                      ' , 'NEAR BND PF=T'],
  ['jns'           , 'rel16'                        , 'x86:d:  0f 89 ow                      ' , 'NEAR BND FLAGS.SF=T'],
  ['jns'           , 'rel32'                        , 'd:      0f 89 od                      ' , 'NEAR BND FLAGS.SF=T'],
  ['jnz'           , 'rel16'                        , 'x86:d:  0f 85 ow                      ' , 'NEAR BND ZF=T'],
  ['jnz'           , 'rel32'                        , 'd:      0f 85 od                      ' , 'NEAR BND ZF=T'],
  ['jo'            , 'rel16'                        , 'x86:d:  0f 80 ow                      ' , 'NEAR BND OF=T'],
  ['jo'            , 'rel32'                        , 'd:      0f 80 od                      ' , 'NEAR BND OF=T'],
  ['jp'            , 'rel16'                        , 'x86:d:  66 0f 8a ow                   ' , 'NEAR BND PF=T'],
  ['jp'            , 'rel32'                        , 'd:      0f 8a od                      ' , 'NEAR BND PF=T'],
  ['jpe'           , 'rel16'                        , 'x86:d:  0f 8a ow                      ' , 'NEAR BND PF=T'],
  ['jpe'           , 'rel32'                        , 'd:      0f 8a od                      ' , 'NEAR BND PF=T'],
  ['jpo'           , 'rel16'                        , 'x86:d:  0f 8b ow                      ' , 'NEAR BND PF=T'],
  ['jpo'           , 'rel32'                        , 'd:      0f 8b od                      ' , 'NEAR BND PF=T'],
  ['js'            , 'rel16'                        , 'x86:d:  0f 88 ow                      ' , 'NEAR BND FLAGS.SF=T'],
  ['js'            , 'rel32'                        , 'd:      0f 88 od                      ' , 'NEAR BND FLAGS.SF=T'],
  ['jz'            , 'rel16'                        , 'x86:d:  0f 84 ow                      ' , 'NEAR BND ZF=T'],
  ['jz'            , 'rel32'                        , 'd:      0f 84 od                      ' , 'NEAR BND ZF=T'],

  ['jmp'           , 'rel8'                         , 'd:      eb ob                         ' , 'SHORT BND'],
  ['jmp'           , 'rel16'                        , 'x86:d:  e9 ow                         ' , 'NEAR BND'],
  ['jmp'           , 'rel32'                        , 'd:      e9 od                         ' , 'NEAR BND'],
  ['jmp'           , 'R:r/m16'                      , 'x86:m:  66 ff /4                      ' , 'NEAR BND'],
  ['jmp'           , 'R:r/m32'                      , 'x86:m:  ff /4                         ' , 'NEAR BND'],
  ['jmp'           , 'R:r/m64'                      , 'x64:m:  ff /4                         ' , 'NEAR BND'],
  ['jmp'           , 'ptr16:16'                     , 'x86:d:  66 ea od                      ' , 'FAR'],
  ['jmp'           , 'ptr16:32'                     , 'x86:d:  ea op                         ' , 'FAR'],
  ['jmp'           , 'm16:16'                       , 'm:      66 ff /5                      ' , 'FAR'],
  ['jmp'           , 'm16:32'                       , 'm:      ff /5                         ' , 'FAR'],
  ['jmp'           , 'm16:64'                       , 'x64:m:  rex.w ff /5                   ' , 'FAR'],
  ...
  ['lar'           , 'W:r16, r/m16'                 , 'rm:  66 0f 02 /r                   ' , 'ZF=M'],
  ['lar'           , 'W:reg, r32/m16'               , 'rm:  0f 02 /r                      ' , 'ZF=M'],
  ...
  ['lds'           , 'W:r16, m16:16'                , 'x86:rm:  66 c5 /r                      ' , ''],
  ['lds'           , 'W:r32, m16:32'                , 'x86:rm:  c5 /r                         ' , ''],
  ['lss'           , 'W:r16, m16:16'                , 'rm:      66 0f b2 /r                   ' , ''],
  ['lss'           , 'W:r32, m16:32'                , 'rm:      0f b2 /r                      ' , ''],
  ['les'           , 'W:r16, m16:16'                , 'x86:rm:  66 c4 /r                      ' , ''],
  ['les'           , 'W:r32, m16:32'                , 'x86:rm:  c4 /r                         ' , ''],
  ['lfs'           , 'W:r16, m16:16'                , 'rm:      66 0f b4 /r                   ' , ''],
  ['lfs'           , 'W:r32, m16:32'                , 'rm:      0f b4 /r                      ' , ''],
  ['lgs'           , 'W:r16, m16:16'                , 'rm:      66 0f b5 /r                   ' , ''],
  ['lgs'           , 'W:r32, m16:32'                , 'rm:      0f b5 /r                      ' , ''],

  ['lea'           , 'W:r16, mem'                   , 'rm:      66 8d /r                      ' , ''],
  ['lea'           , 'W:r32, mem'                   , 'rm:      8d /r                         ' , ''],
  ['lea'           , 'W:r64, mem'                   , 'x64:rm:  rex.w 8d /r                   ' , ''],
  ...
  ['lodsw'         , 'W:<ax>, <[ds:*si]>'           , '      66 ad                         ' , 'REP'],
  ['lodsd'         , 'W:<eax>, <[ds:*si]>'          , '      ad                            ' , 'REP'],
  ['lodsq'         , 'W:<rax>, <[*si]>'             , 'x64:  rex.w ad                      ' , 'REP'],

  ['loop'          , 'rel8'                         , 'd:  e2 ob                         ' , 'SHORT'],
  ['loope'         , 'rel8'                         , 'd:  e1 ob                         ' , 'SHORT ZF=T'],
  ['loopne'        , 'rel8'                         , 'd:  e0 ob                         ' , 'SHORT ZF=T'],

  ['lsl'           , 'W:r16, r/m16'                 , 'rm:  66 0f 03 /r                   ' , 'ZF=M'],
  ['lsl'           , 'W:r32, r32/m16'               , 'rm:  0f 03 /r                      ' , 'ZF=M'],
  ['lsl'           , 'W:r64, r32/m16'               , 'rm:  rex.w 0f 03 /r                ' , 'ZF=M'],

  ['ltr'           , 'R:r/m16'                      , 'm:  0f 00 /3                      ' , 'LEVEL=0'],

  ['lzcnt'         , 'W:r16, r/m16'                 , 'rm:      66 f3 0f bd /r                ' , 'CPUID=LZCNT OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ['lzcnt'         , 'W:r32, r/m32'                 , 'rm:      f3 0f bd /r                   ' , 'CPUID=LZCNT OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ['lzcnt'         , 'W:r64, r/m64'                 , 'x64:rm:  f3 rex.w 0f bd /r             ' , 'CPUID=LZCNT OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ...
  ['mov'           , 'W:r/m16, r16'                 , 'mr:      66 89 /r                      ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r/m32, r32'                 , 'mr:      89 /r                         ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r/m64, r64'                 , 'x64:mr:  rex.w 89 /r                   ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r8, r/m8'                   , 'rm:      8a /r                         ' , ''],
  ['mov'           , 'W:r16, r/m16'                 , 'rm:      66 8b /r                      ' , ''],
  ['mov'           , 'W:r32, r/m32'                 , 'rm:      8b /r                         ' , ''],
  ['mov'           , 'W:r64, r/m64'                 , 'x64:rm:  rex.w 8b /r                   ' , ''],
  ['mov'           , 'W:r/m16, sreg'                , 'mr:      8c /r                         ' , ''],
  ['mov'           , 'W:r/m64, sreg'                , 'mr:      rex.w 8c /r                   ' , ''],
  ['mov'           , 'W:sreg, r/m16'                , 'rm:      8e /r                         ' , ''],
  ['mov'           , 'W:sreg, r/m64'                , 'rm:      rex.w 8e /r                   ' , ''],
  ['mov'           , 'W:al, moffs8'                 , 'd:       a0 mb                         ' , ''],
  ['mov'           , 'W:al, moffs8'                 , 'x64:d:   rex.w a0 mb                   ' , ''],
  ['mov'           , 'W:ax, moffs16'                , 'd:       66 a1 mw                      ' , ''],
  ['mov'           , 'W:eax, moffs32'               , 'd:       a1 md                         ' , ''],
  ['mov'           , 'W:rax, moffs64'               , 'x64:d:   rex.w a1 mq                   ' , ''],
  ['mov'           , 'W:moffs8, al'                 , 'd:       a2 mb                         ' , ''],
  ['mov'           , 'W:moffs8, al'                 , 'x64:d:   rex.w a2 mb                   ' , ''],
  ['mov'           , 'W:moffs16, ax'                , 'd:       66 a3 mw                      ' , ''],
  ['mov'           , 'W:moffs32, eax'               , 'd:       a3 md                         ' , ''],
  ['mov'           , 'W:moffs64, rax'               , 'x64:d:   rex.w a3 mq                   ' , ''],
  ['mov'           , 'W:r8, imm8'                   , 'oi:      b0+rb ib                      ' , ''],
  ['mov'           , 'W:r16, imm16'                 , 'oi:      b8+rw iw                      ' , ''],
  ['mov'           , 'W:r32, imm32'                 , 'oi:      b8+rd id                      ' , ''],
  ['mov'           , 'W:r64, imm64'                 , 'x64:oi:  rex.w b8+rd iq                ' , ''],
  ['mov'           , 'W:r/m8, imm8'                 , 'mi:      c6 /0 ib                      ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r/m16, imm16'               , 'mi:      66 c7 /0 iw                   ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r/m32, imm32'               , 'mi:      c7 /0 id                      ' , 'LOCK:HARDWARE'],
  ['mov'           , 'W:r/m64, imm32'               , 'x64:mi:  rex.w c7 /0 id                ' , 'LOCK:HARDWARE'],
  ...
  ['movbe'         , 'W:r16, m16'                   , 'rm:      66 0f 38 f0 /r                ' , 'CPUID=MOVBE|SSE4v2'],
  ['movbe'         , 'W:r32, m32'                   , 'rm:      0f 38 f0 /r                   ' , 'CPUID=MOVBE|SSE4v2'],
  ['movbe'         , 'W:r64, m64'                   , 'x64:rm:  rex.w 0f 38 f0 /r             ' , 'CPUID=MOVBE|SSE4v2'],
  ['movbe'         , 'W:m16, r16'                   , 'mr:      66 0f 38 f1 /r                ' , 'CPUID=MOVBE|SSE4v2'],
  ['movbe'         , 'W:m32, r32'                   , 'mr:      0f 38 f1 /r                   ' , 'CPUID=MOVBE|SSE4v2'],
  ['movbe'         , 'W:m64, r64'                   , 'x64:mr:  rex.w 0f 38 f1 /r             ' , 'CPUID=MOVBE|SSE4v2'],
  ...
  ['movhpd'        , 'xmm, m64'                     , 'rm:       66 0f 16 /r                   ' , 'CPUID=SSE2'],
  ...
  ['movhps'        , 'xmm, m64'                     , 'rm:      0f 16 /r                      ' , 'CPUID=SSE'],
  ...
  ['movlpd'        , 'xmm, m64'                     , 'rm:       66 0f 12 /r                   ' , 'CPUID=SSE2'],
  ...
  ['movlps'        , 'xmm, m64'                     , 'rm:      0f 12 /r                      ' , 'CPUID=SSE'],
  ...
  ['movnti'        , 'W:m32, r32'                   , 'mr:      0f c3 /r                      ' , 'CPUID=SSE2'],
  ['movnti'        , 'W:m64, r64'                   , 'x64:mr:  rex.w 0f c3 /r                ' , 'CPUID=SSE2'],
  ...
  ['movsw'         , 'W:<[es:*di]>, <[ds:*si]>'     , '      66 a5                         ' , 'REP'],
  ['movsd'         , 'W:<[es:*di]>, <[ds:*si]>'     , '      a5                            ' , 'REP'],
  ['movsq'         , 'W:<[*di]>, <[*si]>'           , 'x64:  rex.w a5                      ' , 'REP'],

  ['movsd'         , 'xmm, xmm'                     , 'rm:      f2 0f 10 /r                   ' , 'REP CPUID=SSE2'],
  ['movsd'         , 'xmm, m64'                     , 'rm:      f2 0f 10 /r                   ' , 'REP CPUID=SSE2'],
  ...
  ['vmovsd'        , 'xmm {kz}, m64'                , 'rm:t1s:  evex.lig.f2.0f.w1 10 /r       ' , 'CPUID=AVX512F'],
  ...
  ['movss'         , 'xmm, xmm'                     , 'rm:      f3 0f 10 /r                   ' , 'CPUID=SSE'],
  ['movss'         , 'xmm, m32'                     , 'rm:      f3 0f 10 /r                   ' , 'CPUID=SSE'],
  ...
  ['vmovss'        , 'xmm {kz}, m32'                , 'rm:t1s:  evex.lig.f3.0f.w0 10 /r       ' , 'CPUID=AVX512F'],
  ...
  ['movsx'         , 'W:r16, r/m8'                  , 'rm:      66 0f be /r                   ' , ''],
  ['movsx'         , 'W:r32, r/m8'                  , 'rm:      0f be /r                      ' , ''],
  ['movsx'         , 'W:r32, r/m16'                 , 'rm:      0f bf /r                      ' , ''],
  ['movsx'         , 'W:r64, r/m16'                 , 'x64:rm:  rex.w 0f bf /r                ' , ''],
  ...
  ['movzx'         , 'W:r16, r/m8'                  , 'rm:      66 0f b6 /r                   ' , ''],
  ['movzx'         , 'W:r32, r/m8'                  , 'rm:      0f b6 /r                      ' , ''],
  ['movzx'         , 'W:r64, r/m8'                  , 'x64:rm:  rex.w 0f b6 /r                ' , ''],
  ['movzx'         , 'W:r32, r/m16'                 , 'rm:      0f b7 /r                      ' , ''],
  ['movzx'         , 'W:r64, r/m16'                 , 'x64:rm:  rex.w 0f b7 /r                ' , ''],
  ...
  ['mul'           , 'R:r/m16, X:<dx>, X:<ax>'      , 'm:      66 f7 /4                      ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['mul'           , 'R:r/m32, X:<edx>, X:<eax>'    , 'm:      f7 /4                         ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ['mul'           , 'R:r/m64, X:<rdx>, X:<rax>'    , 'x64:m:  rex.w f7 /4                   ' , 'OF=M FLAGS.SF=U ZF=U AF=U PF=U CF=M'],
  ...
  ['neg'           , 'r/m16'                        , 'm:      66 f7 /3                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['neg'           , 'r/m32'                        , 'm:      f7 /3                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['neg'           , 'r/m64'                        , 'x64:m:  rex.w f7 /3                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],

  ['nop'           , ''                             , '    90                            ' , ''],
  ['nop'           , 'R:r/m16'                      , 'm:  66 0f 1f /0                   ' , ''],
  ['nop'           , 'R:r/m32'                      , 'm:  0f 1f /0                      ' , ''],

  ['not'           , 'r/m8'                         , 'm:      f6 /2                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT'],
  ['not'           , 'r/m16'                        , 'm:      66 f7 /2                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT'],
  ['not'           , 'r/m32'                        , 'm:      f7 /2                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT'],
  ['not'           , 'r/m64'                        , 'x64:m:  rex.w f7 /2                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT'],

  ['or'            , 'al, imm8'                     , 'i:       0c ib                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'ax, imm16'                    , 'i:       66 0d iw                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'eax, imm32'                   , 'i:       0d id                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'rax, imm32'                   , 'x64:i:   rex.w 0d id                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m8, imm8'                   , 'mi:      80 /1 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m16, imm16'                 , 'mi:      66 81 /1 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m32, imm32'                 , 'mi:      81 /1 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /1 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m16, imm8'                  , 'mi:      66 83 /1 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m32, imm8'                  , 'mi:      83 /1 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /1 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m8, r8'                     , 'mr:      08 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m16, r16'                   , 'mr:      66 09 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m32, r32'                   , 'mr:      09 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r/m64, r64'                   , 'x64:mr:  rex.w 09 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r8, r/m8'                     , 'rm:      0a /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r16, r/m16'                   , 'rm:      66 0b /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r32, r/m32'                   , 'rm:      0b /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['or'            , 'r64, r/m64'                   , 'x64:rm:  rex.w 0b /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ...
  ['out'           , 'imm8, al'                     , 'i:  e6 ib                         ' , ''],
  ['out'           , 'imm8, ax'                     , 'i:  66 e7 ib                      ' , ''],
  ['out'           , 'imm8, eax'                    , 'i:  e7 ib                         ' , ''],
  ['out'           , 'dx, al'                       , '    ee                            ' , ''],
  ['out'           , 'dx, ax'                       , '    66 ef                         ' , ''],
  ['out'           , 'dx, eax'                      , '    ef                            ' , ''],

  ['outsb'         , 'R:<dx>, <[ds:*si]>'           , '  6e                            ' , 'REP'],
  ['outsw'         , 'R:<dx>, <[ds:*si]>'           , '  66 6f                         ' , 'REP'],
  ['outsd'         , 'R:<dx>, <[ds:*si]>'           , '  6f                            ' , 'REP'],
  ...
  ['popa'          , 'W:<di>, W:<si>, W:<bp>, W:<bx>, W:<dx>, W:<cx>, W:<ax>'        , 'x86:  66 61                         ' , ''],
  ['popad'         , 'W:<edi>, W:<esi>, W:<ebp>, W:<ebx>, W:<edx>, W:<ecx>, W:<eax>' , 'x86:  61                            ' , ''],

  ['popcnt'        , 'W:r16, r/m16'                 , 'rm:      66 f3 0f b8 /r                ' , 'CPUID=POPCNT OF=C FLAGS.SF=C ZF=M AF=C PF=C CF=C'],
  ['popcnt'        , 'W:r32, r/m32'                 , 'rm:      f3 0f b8 /r                   ' , 'CPUID=POPCNT OF=C FLAGS.SF=C ZF=M AF=C PF=C CF=C'],
  ['popcnt'        , 'W:r64, r/m64'                 , 'x64:rm:  f3 rex.w 0f b8 /r             ' , 'CPUID=POPCNT OF=C FLAGS.SF=C ZF=M AF=C PF=C CF=C'],

  ['popf'          , ''                             , '      9d                            ' , 'OF=P FLAGS.SF=P ZF=P AF=P PF=P CF=P TF=P IF=P DF=P NT=P'],
  ['popfd'         , ''                             , 'x86:  9d                            ' , ''],
  ['popfq'         , ''                             , 'x64:  9d                            ' , ''],
  ...
  ['ptwrite'       , 'R:r/m64'                      , 'x64:m:  f3 rex.w 0f ae /4             ' , 'CPUID=PTWRITE'],
  ['ptwrite'       , 'R:r/m32'                      , 'm:      f3 0f ae /4                   ' , 'CPUID=PTWRITE'],
  ...
  ['pusha'         , 'R:<ax>, <cx>, <dx>, <bx>, <sp>, <bp>, <si>, <di>'         , 'x86:  66 60                         ' , ''],
  ...
  ['rcl'           , 'W:r/m16, 1'                   , 'm:       66 d1 /2                      ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcl'           , 'W:r/m16, cl'                  , 'm:       66 d3 /2                      ' , 'OF=U CF=TM'],
  ['rcl'           , 'W:r/m16, imm8'                , 'mi:      66 c1 /2 ib                   ' , 'OF=U CF=TM'],
  ['rcl'           , 'W:r/m32, 1'                   , 'm:       d1 /2                         ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcl'           , 'W:r/m64, 1'                   , 'x64:m:   rex.w d1 /2                   ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcl'           , 'W:r/m32, cl'                  , 'm:       d3 /2                         ' , 'OF=U CF=TM'],
  ['rcl'           , 'W:r/m64, cl'                  , 'x64:m:   rex.w d3 /2                   ' , 'OF=U CF=TM'],
  ['rcl'           , 'W:r/m32, imm8'                , 'mi:      c1 /2 ib                      ' , 'OF=U CF=TM'],
  ['rcl'           , 'W:r/m64, imm8'                , 'x64:mi:  rex.w c1 /2 ib                ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m8, 1'                    , 'm:       d0 /3                         ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcr'           , 'W:r/m8, cl'                   , 'm:       d2 /3                         ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m8, imm8'                 , 'mi:      c0 /3 ib                      ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m16, 1'                   , 'm:       66 d1 /3                      ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcr'           , 'W:r/m16, cl'                  , 'm:       66 d3 /3                      ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m16, imm8'                , 'mi:      66 c1 /3 ib                   ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m32, 1'                   , 'm:       d1 /3                         ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcr'           , 'W:r/m64, 1'                   , 'x64:m:   rex.w d1 /3                   ' , 'OF=M CF=TM OF=U CF=TM'],
  ['rcr'           , 'W:r/m32, cl'                  , 'm:       d3 /3                         ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m64, cl'                  , 'x64:m:   rex.w d3 /3                   ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m32, imm8'                , 'mi:      c1 /3 ib                      ' , 'OF=U CF=TM'],
  ['rcr'           , 'W:r/m64, imm8'                , 'x64:mi:  rex.w c1 /3 ib                ' , 'OF=U CF=TM'],
  ['rol'           , 'W:r/m8, 1'                    , 'm:       d0 /0                         ' , 'OF=M CF=M OF=U CF=M'],
  ['rol'           , 'W:r/m8, cl'                   , 'm:       d2 /0                         ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m8, imm8'                 , 'mi:      c0 /0 ib                      ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m16, 1'                   , 'm:       66 d1 /0                      ' , 'OF=M CF=M OF=U CF=M'],
  ['rol'           , 'W:r/m16, cl'                  , 'm:       66 d3 /0                      ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m16, imm8'                , 'mi:      66 c1 /0 ib                   ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m32, 1'                   , 'm:       d1 /0                         ' , 'OF=M CF=M OF=U CF=M'],
  ['rol'           , 'W:r/m64, 1'                   , 'x64:m:   rex.w d1 /0                   ' , 'OF=M CF=M OF=U CF=M'],
  ['rol'           , 'W:r/m32, cl'                  , 'm:       d3 /0                         ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m64, cl'                  , 'x64:m:   rex.w d3 /0                   ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m32, imm8'                , 'mi:      c1 /0 ib                      ' , 'OF=U CF=M'],
  ['rol'           , 'W:r/m64, imm8'                , 'x64:mi:  rex.w c1 /0 ib                ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m8, 1'                    , 'm:       d0 /1                         ' , 'OF=M CF=M OF=U CF=M'],
  ['ror'           , 'W:r/m8, cl'                   , 'm:       d2 /1                         ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m8, imm8'                 , 'mi:      c0 /1 ib                      ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m16, 1'                   , 'm:       66 d1 /1                      ' , 'OF=M CF=M OF=U CF=M'],
  ['ror'           , 'W:r/m16, cl'                  , 'm:       66 d3 /1                      ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m16, imm8'                , 'mi:      66 c1 /1 ib                   ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m32, 1'                   , 'm:       d1 /1                         ' , 'OF=M CF=M OF=U CF=M'],
  ['ror'           , 'W:r/m64, 1'                   , 'x64:m:   rex.w d1 /1                   ' , 'OF=M CF=M OF=U CF=M'],
  ['ror'           , 'W:r/m32, cl'                  , 'm:       d3 /1                         ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m64, cl'                  , 'x64:m:   rex.w d3 /1                   ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m32, imm8'                , 'mi:      c1 /1 ib                      ' , 'OF=U CF=M'],
  ['ror'           , 'W:r/m64, imm8'                , 'x64:mi:  rex.w c1 /1 ib                ' , 'OF=U CF=M'],
  ...
  ['rdfsbase'      , 'W:r32'                        , 'x64:m:  f3 0f ae /0                   ' , 'CPUID=FSGSBASE'],
  ['rdfsbase'      , 'W:r64'                        , 'x64:m:  f3 rex.w 0f ae /0             ' , 'CPUID=FSGSBASE'],
  ['rdgsbase'      , 'W:r32'                        , 'x64:m:  f3 0f ae /1                   ' , 'CPUID=FSGSBASE'],
  ['rdgsbase'      , 'W:r64'                        , 'x64:m:  f3 rex.w 0f ae /1             ' , 'CPUID=FSGSBASE'],
  ...
  ['rdrand'        , 'W:r16'                        , 'm:      66 0f c7 /6                   ' , 'CPUID=RDRAND OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],
  ['rdrand'        , 'W:r32'                        , 'm:      0f c7 /6                      ' , 'CPUID=RDRAND OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],
  ['rdrand'        , 'W:r64'                        , 'x64:m:  rex.w 0f c7 /6                ' , 'CPUID=RDRAND OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],

  ['rdseed'        , 'W:r16'                        , 'm:      66 0f c7 /7                   ' , 'CPUID=RDSEED OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],
  ['rdseed'        , 'W:r32'                        , 'm:      0f c7 /7                      ' , 'CPUID=RDSEED OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],
  ['rdseed'        , 'W:r64'                        , 'x64:m:  rex.w 0f c7 /7                ' , 'CPUID=RDSEED OF=C FLAGS.SF=C ZF=C AF=C PF=C CF=M'],
  ...
  ['sal'           , 'r/m16, 1'                     , 'm:       66 d1 /4                      ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m16, cl'                    , 'm:       66 d3 /4                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m16, imm8'                  , 'mi:      66 c1 /4 ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m32, 1'                     , 'm:       d1 /4                         ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m64, 1'                     , 'x64:m:   rex.w d1 /4                   ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m32, cl'                    , 'm:       d3 /4                         ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m64, cl'                    , 'x64:m:   rex.w d3 /4                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m32, imm8'                  , 'mi:      c1 /4 ib                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sal'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w c1 /4 ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ...
  ['sar'           , 'r/m16, 1'                     , 'm:       66 d1 /7                      ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m16, cl'                    , 'm:       66 d3 /7                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m16, imm8'                  , 'mi:      66 c1 /7 ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m32, 1'                     , 'm:       d1 /7                         ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m64, 1'                     , 'x64:m:   rex.w d1 /7                   ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m32, cl'                    , 'm:       d3 /7                         ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m64, cl'                    , 'x64:m:   rex.w d3 /7                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m32, imm8'                  , 'mi:      c1 /7 ib                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['sar'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w c1 /7 ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m8, 1'                      , 'm:       d0 /4                         ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m8, cl'                     , 'm:       d2 /4                         ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m8, imm8'                   , 'mi:      c0 /4 ib                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m16, 1'                     , 'm:       66 d1 /4                      ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m16, cl'                    , 'm:       66 d3 /4                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m16, imm8'                  , 'mi:      66 c1 /4 ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m32, 1'                     , 'm:       d1 /4                         ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m64, 1'                     , 'x64:m:   rex.w d1 /4                   ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m32, cl'                    , 'm:       d3 /4                         ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m64, cl'                    , 'x64:m:   rex.w d3 /4                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m32, imm8'                  , 'mi:      c1 /4 ib                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shl'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w c1 /4 ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ...
  ['shr'           , 'r/m16, 1'                     , 'm:       66 d1 /5                      ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m16, cl'                    , 'm:       66 d3 /5                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m16, imm8'                  , 'mi:      66 c1 /5 ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m32, 1'                     , 'm:       d1 /5                         ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m64, 1'                     , 'x64:m:   rex.w d1 /5                   ' , 'OF=M FLAGS.SF=M ZF=M AF=U PF=M CF=M OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m32, cl'                    , 'm:       d3 /5                         ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m64, cl'                    , 'x64:m:   rex.w d3 /5                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m32, imm8'                  , 'mi:      c1 /5 ib                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shr'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w c1 /5 ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ...
  ['sbb'           , 'W:ax, imm16'                  , 'i:       66 1d iw                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:eax, imm32'                 , 'i:       1d id                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:rax, imm32'                 , 'x64:i:   rex.w 1d id                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m8, imm8'                 , 'mi:      80 /3 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m16, imm16'               , 'mi:      66 81 /3 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m32, imm32'               , 'mi:      81 /3 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m64, imm32'               , 'x64:mi:  rex.w 81 /3 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m16, imm8'                , 'mi:      66 83 /3 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m32, imm8'                , 'mi:      83 /3 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m64, imm8'                , 'x64:mi:  rex.w 83 /3 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m8, r8'                   , 'mr:      18 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m16, r16'                 , 'mr:      66 19 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m32, r32'                 , 'mr:      19 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r/m64, r64'                 , 'x64:mr:  rex.w 19 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r8, r/m8'                   , 'rm:      1a /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r16, r/m16'                 , 'rm:      66 1b /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r32, r/m32'                 , 'rm:      1b /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],
  ['sbb'           , 'W:r64, r/m64'                 , 'x64:rm:  rex.w 1b /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=TM'],

  ['scasb'         , 'R:<al>, <[es:*di]>'           , '      ae                            ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['scasw'         , 'R:<ax>, <[es:*di]>'           , '      66 af                         ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['scasd'         , 'R:<eax>, <[es:*di]>'          , '      af                            ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['scasq'         , 'R:<rax>, <[rdi]>'             , 'x64:  rex.w af                      ' , 'REPE REPNE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],

  ['seta'          , 'R:r/m8'                       , 'm:  0f 97                         ' , 'CF=T ZF=T'],
  ['setae'         , 'R:r/m8'                       , 'm:  0f 93                         ' , 'CF=T'],
  ['setb'          , 'R:r/m8'                       , 'm:  0f 92                         ' , 'CF=T'],
  ['setbe'         , 'R:r/m8'                       , 'm:  0f 96                         ' , 'CF=T ZF=T'],
  ['setc'          , 'R:r/m8'                       , 'm:  0f 92                         ' , 'CF=T'],
  ...
  ['setna'         , 'R:r/m8'                       , 'm:  0f 96                         ' , 'CF=T ZF=T'],
  ['setnae'        , 'R:r/m8'                       , 'm:  0f 92                         ' , 'CF=T'],
  ['setnb'         , 'R:r/m8'                       , 'm:  0f 93                         ' , 'CF=T'],
  ['setnbe'        , 'R:r/m8'                       , 'm:  0f 97                         ' , 'CF=T ZF=T'],
  ['setnc'         , 'R:r/m8'                       , 'm:  0f 93                         ' , 'CF=T'],
  ['setne'         , 'R:r/m8'                       , 'm:  0f 95                         ' , 'ZF=T'],
  ['setng'         , 'R:r/m8'                       , 'm:  0f 9e                         ' , 'ZF=T FLAGS.SF=T OF=T'],
  ['setnge'        , 'R:r/m8'                       , 'm:  0f 9c                         ' , 'FLAGS.SF=T OF=T'],
  ['setnl'         , 'R:r/m8'                       , 'm:  0f 9d                         ' , 'FLAGS.SF=T OF=T'],
  ['setnle'        , 'R:r/m8'                       , 'm:  0f 9f                         ' , 'ZF=T FLAGS.SF=T OF=T'],
  ['setno'         , 'R:r/m8'                       , 'm:  0f 91                         ' , 'OF=T'],
  ['setnp'         , 'R:r/m8'                       , 'm:  0f 9b                         ' , 'PF=T'],
  ['setns'         , 'R:r/m8'                       , 'm:  0f 99                         ' , 'FLAGS.SF=T'],
  ['setnz'         , 'R:r/m8'                       , 'm:  0f 95                         ' , 'ZF=T'],
  ['seto'          , 'R:r/m8'                       , 'm:  0f 90                         ' , 'OF=T'],
  ['setp'          , 'R:r/m8'                       , 'm:  0f 9a                         ' , 'PF=T'],
  ['setpe'         , 'R:r/m8'                       , 'm:  0f 9a                         ' , 'PF=T'],
  ['setpo'         , 'R:r/m8'                       , 'm:  0f 9b                         ' , 'PF=T'],
  ['sets'          , 'R:r/m8'                       , 'm:  0f 98                         ' , 'FLAGS.SF=T'],
  ['setz'          , 'R:r/m8'                       , 'm:  0f 94                         ' , 'ZF=T'],
  ...
  ['shld'          , 'W:r/m16, r16, imm8'           , 'mri:      66 0f a4 /r ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shld'          , 'W:r/m16, r16, cl'             , 'mr:       66 0f a5 /r                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shld'          , 'W:r/m32, r32, imm8'           , 'mri:      0f a4 /r ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shld'          , 'W:r/m64, r64, imm8'           , 'x64:mri:  rex.w 0f a4 /r ib             ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shld'          , 'W:r/m32, r32, cl'             , 'mr:       0f a5 /r                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shld'          , 'W:r/m64, r64, cl'             , 'x64:mr:   rex.w 0f a5 /r                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],

  ['shrd'          , 'W:r/m16, r16, imm8'           , 'mri:      66 0f ac /r ib                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shrd'          , 'W:r/m16, r16, cl'             , 'mr:       66 0f ad /r                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shrd'          , 'W:r/m32, r32, imm8'           , 'mri:      0f ac /r ib                   ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shrd'          , 'W:r/m64, r64, imm8'           , 'x64:mri:  rex.w 0f ac /r ib             ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shrd'          , 'W:r/m32, r32, cl'             , 'mr:       0f ad /r                      ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ['shrd'          , 'W:r/m64, r64, cl'             , 'x64:mr:   rex.w 0f ad /r                ' , 'OF=U FLAGS.SF=M ZF=M AF=U PF=M CF=M'],
  ...
  ['sldt'          , 'W:r/m16'                      , 'm:  0f 00 /0                      ' , ''],
  ['sldt'          , 'W:r64/m16'                    , 'm:  rex.w 0f 00 /0                ' , ''],

  ['smsw'          , 'W:r/m16'                      , 'm:  66 0f 01 /4                   ' , ''],
  ['smsw'          , 'W:r32/m16'                    , 'm:  0f 01 /4                      ' , ''],
  ['smsw'          , 'W:r64/m16'                    , 'm:  rex.w 0f 01 /4                ' , ''],
  ...
  ['stosw'         , 'W:<[es:*di]>, <ax>'           , '      66 ab                         ' , 'REP'],
  ['stosd'         , 'W:<[es:*di]>, <eax>'          , '      ab                            ' , 'REP'],
  ['stosq'         , 'W:<[rdi]>, <rax>'             , 'x64:  rex.w ab                      ' , 'REP'],

  ['str'           , 'W:r/m16'                      , 'm:  0f 00 /1                      ' , ''],

  ['sub'           , 'al, imm8'                     , 'i:       2c ib                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'ax, imm16'                    , 'i:       66 2d iw                      ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'eax, imm32'                   , 'i:       2d id                         ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'rax, imm32'                   , 'x64:i:   rex.w 2d id                   ' , 'OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m8, imm8'                   , 'mi:      80 /5 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m16, imm16'                 , 'mi:      66 81 /5 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m32, imm32'                 , 'mi:      81 /5 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /5 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m16, imm8'                  , 'mi:      66 83 /5 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m32, imm8'                  , 'mi:      83 /5 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /5 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m8, r8'                     , 'mr:      28 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m16, r16'                   , 'mr:      66 29 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m32, r32'                   , 'mr:      29 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 29 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r8, r/m8'                     , 'rm:      2a /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r16, r/m16'                   , 'rm:      66 2b /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r32, r/m32'                   , 'rm:      2b /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['sub'           , 'r64, r/m64'                   , 'x64:rm:  rex.w 2b /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ...
  ['sysret'        , ''                             , 'x64:  0f 07                         ' , ''],
  ['sysret'        , ''                             , 'x64:  rex.w 0f 07                   ' , ''],

  ['test'          , 'R:al, imm8'                   , 'i:       a8 ib                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:ax, imm16'                  , 'i:       66 a9 iw                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:eax, imm32'                 , 'i:       a9 id                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:rax, imm32'                 , 'x64:i:   rex.w a9 id                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m8, imm8'                 , 'mi:      f6 /0 ib                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m16, imm16'               , 'mi:      66 f7 /0 iw                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m32, imm32'               , 'mi:      f7 /0 id                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m64, imm32'               , 'x64:mi:  rex.w f7 /0 id                ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m8, r8'                   , 'mr:      84 /r                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m16, r16'                 , 'mr:      66 85 /r                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m32, r32'                 , 'mr:      85 /r                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['test'          , 'R:r/m64, r64'                 , 'x64:mr:  rex.w 85 /r                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],

  ['tzcnt'         , 'W:r16, r/m16'                 , 'rm:      66 f3 0f bc /r                ' , 'CPUID=BMI1 OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ['tzcnt'         , 'W:r32, r/m32'                 , 'rm:      f3 0f bc /r                   ' , 'CPUID=BMI1 OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ['tzcnt'         , 'W:r64, r/m64'                 , 'x64:rm:  f3 rex.w 0f bc /r             ' , 'CPUID=BMI1 OF=U FLAGS.SF=U ZF=M AF=U PF=U CF=M'],
  ...
  ['wait'          , ''                             , '  9b                            ' , 'CPUID=FPU C3=U C2=U C1=U C0=U'],
  ['fwait'         , ''                             , '  9b                            ' , 'CPUID=FPU C3=U C2=U C1=U C0=U'],

  ['wbinvd'        , ''                             , '0f 09                         ' , 'LEVEL=0'],

  ['wrfsbase'      , 'R:r32'                        , 'x64:m:  f3 0f ae /2                   ' , 'CPUID=FSGSBASE'],
  ['wrfsbase'      , 'R:r64'                        , 'x64:m:  f3 rex.w 0f ae /2             ' , 'CPUID=FSGSBASE'],
  ['wrgsbase'      , 'R:r32'                        , 'x64:m:  f3 0f ae /3                   ' , 'CPUID=FSGSBASE'],
  ['wrgsbase'      , 'R:r64'                        , 'x64:m:  f3 rex.w 0f ae /3             ' , 'CPUID=FSGSBASE'],
  ...
  ['xadd'          , 'r/m16, X:r16'                 , 'mr:      66 0f c1 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['xadd'          , 'r/m32, X:r32'                 , 'mr:      0f c1 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],
  ['xadd'          , 'r/m64, X:r64'                 , 'x64:mr:  rex.w 0f c1 /r                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=M FLAGS.SF=M ZF=M AF=M PF=M CF=M'],

  ['xbegin'        , 'rel16'                        , 'd:  66 c7 f8                      ' , 'CPUID=RTM'],
  ['xbegin'        , 'rel32'                        , 'd:  c7 f8                         ' , 'CPUID=RTM'],

  ['xchg'          , 'ax, X:r16'                    , 'o:       66 90+rw                      ' , ''],
  ['xchg'          , 'r16, X:ax'                    , 'o:       90+rw                         ' , ''],
  ['xchg'          , 'eax, X:r32'                   , 'o:       90+rd                         ' , ''],
  ['xchg'          , 'rax, X:r64'                   , 'x64:o:   rex.w 90+rd                   ' , ''],
  ['xchg'          , 'r32, X:eax'                   , 'o:       90+rd                         ' , ''],
  ['xchg'          , 'r64, X:rax'                   , 'x64:o:   rex.w 90+rd                   ' , ''],
  ['xchg'          , 'r/m8, r8'                     , 'mr:      86 /r                         ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'W:r8, r/m8'                   , 'rm:      86 /r                         ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'r/m16, r16'                   , 'mr:      66 87 /r                      ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'W:r16, r/m16'                 , 'rm:      66 87 /r                      ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'r/m32, r32'                   , 'mr:      87 /r                         ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'r/m64, r64'                   , 'x64:mr:  rex.w 87 /r                   ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'W:r32, r/m32'                 , 'rm:      87 /r                         ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ['xchg'          , 'W:r64, r/m64'                 , 'x64:rm:  rex.w 87 /r                   ' , 'LOCK:LEGACY:HARDWARE:IMPLIED'],
  ...
  ['xlat'          , 'al, <[*bx+al]>'               , '      d7                            ' , ''],
  ['xlatb'         , 'al, <[*bx+al]>'               , '      d7                            ' , ''],
  ['xlatb'         , 'al, <[rbx+al]>'               , 'x64:  rex.w d7                      ' , ''],

  ['xor'           , 'al, imm8'                     , 'i:       34 ib                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'ax, imm16'                    , 'i:       66 35 iw                      ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'eax, imm32'                   , 'i:       35 id                         ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'rax, imm32'                   , 'x64:i:   rex.w 35 id                   ' , 'OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m8, imm8'                   , 'mi:      80 /6 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m16, imm16'                 , 'mi:      66 81 /6 iw                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m32, imm32'                 , 'mi:      81 /6 id                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m64, imm32'                 , 'x64:mi:  rex.w 81 /6 id                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m16, imm8'                  , 'mi:      66 83 /6 ib                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m32, imm8'                  , 'mi:      83 /6 ib                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m64, imm8'                  , 'x64:mi:  rex.w 83 /6 ib                ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m8, r8'                     , 'mr:      30 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m16, r16'                   , 'mr:      66 31 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m32, r32'                   , 'mr:      31 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r/m64, r64'                   , 'x64:mr:  rex.w 31 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r8, r/m8'                     , 'rm:      32 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r16, r/m16'                   , 'rm:      66 33 /r                      ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r32, r/m32'                   , 'rm:      33 /r                         ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ['xor'           , 'r64, r/m64'                   , 'x64:rm:  rex.w 33 /r                   ' , 'LOCK:LEGACY:HARDWARE:EXPLICIT:IGNORE OF=C FLAGS.SF=M ZF=M AF=U PF=M CF=C'],
  ...
  ['xrstor'        , 'R:mem, <edx>, <eax>'          , 'm:      0f ae /5                      ' , 'CPUID=XSAVEC|XSAVE'],
  ['xrstor64'      , 'R:mem, <edx>, <eax>'          , 'x64:m:  rex.w 0f ae /5                ' , 'CPUID=XSAVEC|XSAVE'],

  ['xrstors'       , 'R:mem, <edx>, <eax>'          , 'm:      0f c7 /3                      ' , 'CPUID=XSAVE|XSS'],
  ['xrstors64'     , 'R:mem, <edx>, <eax>'          , 'x64:m:  rex.w 0f c7 /3                ' , 'CPUID=XSAVE|XSS'],

  ['xsave'         , 'W:mem, <edx>, <eax>'          , 'm:      0f ae /4                      ' , 'CPUID=XSAVE'],
  ['xsave64'       , 'W:mem, <edx>, <eax>'          , 'x64:m:  rex.w 0f ae /4                ' , 'CPUID=XSAVE'],

  ['xsavec'        , 'W:mem, <edx>, <eax>'          , 'm:      0f c7 /4                      ' , 'CPUID=XSAVE|XSAVEC'],
  ['xsavec64'      , 'W:mem, <edx>, <eax>'          , 'x64:m:  rex.w 0f c7 /4                ' , 'CPUID=XSAVE|XSAVEC'],

  ['xsaveopt'      , 'W:mem, <edx>, <eax>'          , 'm:  0f ae /6                      ' , 'CPUID=XSAVEOPT'],
  ['xsaveopt64'    , 'W:mem, <edx>, <eax>'          , 'm:  rex.w 0f ae /6                ' , 'CPUID=XSAVEOPT'],

  ['xsaves'        , 'W:mem, <edx>, <eax>'          , 'm:      0f c7 /5                      ' , 'CPUID=XSAVE|XSS'],
  ['xsaves64'      , 'W:mem, <edx>, <eax>'          , 'x64:m:  rex.w 0f c7 /5                ' , 'CPUID=XSAVE|XSS'],
  ...
  ['compd'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 2d /drex0 ib           ' , 'AMD CPUID=SSE5 MXCSR.DE=M MXCSR.IE=M'],

  ['comps'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 2c /drex0 ib           ' , 'AMD CPUID=SSE5 MXCSR.DE=M MXCSR.IE=M'],

  ['comsd'         , 'W:xmm, xmm, xmm/m64, imm8'    , 'xrmi:   0f 25 2f /drex0 ib           ' , 'AMD CPUID=SSE5 MXCSR.DE=M MXCSR.IE=M'],

  ['comss'         , 'W:xmm, xmm, xmm/m32, imm8'    , 'xrmi:   0f 25 2e /drex0 ib           ' , 'AMD CPUID=SSE5 MXCSR.DE=M MXCSR.IE=M'],

  ['cvtph2ps'      , 'W:xmm, xmm/m64'               , 'rm:   0f 7a 30 /r                  ' , 'AMD CPUID=SSE5'],

  ['cvtps2ph'      , 'W:xmm/m64, xmm'               , 'mr:   0f 7a 31 /r                  ' , 'AMD CPUID=SSE5'],

  ['fmaddpd'       , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 01 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddpd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 01 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddpd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 05 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddpd'       , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 05 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmaddps'       , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 00 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddps'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 00 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddps'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 04 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddps'       , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 04 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmaddsd'       , 'W:xmm, xmm, xmm, xmm/m64'     , 'xxrm:   0f 24 03 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddsd'       , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 03 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddsd'       , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 07 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddsd'       , 'W:xmm, xmm/m64, xmm, xmm'     , 'xmrx:   0f 24 07 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmaddss'       , 'W:xmm, xmm, xmm, xmm/m32'     , 'xxrm:   0f 24 02 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddss'       , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 02 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddss'       , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 06 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmaddss'       , 'W:xmm, xmm/m32, xmm, xmm'     , 'xmrx:   0f 24 06 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmsubpd'       , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 09 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubpd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 09 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubpd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 0d /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubpd'       , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 0d /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmsubps'       , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 08 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubps'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 08 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubps'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 0c /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubps'       , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 0c /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmsubsd'       , 'W:xmm, xmm, xmm, xmm/m64'     , 'xxrm:   0f 24 0b /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubsd'       , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 0b /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubsd'       , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 0f /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubsd'       , 'W:xmm, xmm/m64, xmm, xmm'     , 'xmrx:   0f 24 0f /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fmsubss'       , 'W:xmm, xmm, xmm, xmm/m32'     , 'xxrm:   0f 24 0a /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubss'       , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 0a /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubss'       , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 0e /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fmsubss'       , 'W:xmm, xmm/m32, xmm, xmm'     , 'xmrx:   0f 24 0e /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmaddpd'      , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 11 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddpd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 11 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddpd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 15 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddpd'      , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 15 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmaddps'      , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 10 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddps'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 10 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddps'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 14 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddps'      , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 14 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmaddsd'      , 'W:xmm, xmm, xmm, xmm/m64'     , 'xxrm:   0f 24 13 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddsd'      , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 13 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddsd'      , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 17 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddsd'      , 'W:xmm, xmm/m64, xmm, xmm'     , 'xmrx:   0f 24 17 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmaddss'      , 'W:xmm, xmm, xmm, xmm/m32'     , 'xxrm:   0f 24 12 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddss'      , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 12 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddss'      , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 16 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmaddss'      , 'W:xmm, xmm/m32, xmm, xmm'     , 'xmrx:   0f 24 16 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmsubpd'      , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 19 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubpd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 19 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubpd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 1d /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubpd'      , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 1d /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmsubps'      , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 18 /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubps'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 18 /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubps'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 1c /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubps'      , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 1c /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmsubsd'      , 'W:xmm, xmm, xmm, xmm/m64'     , 'xxrm:   0f 24 1b /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubsd'      , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 1b /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubsd'      , 'W:xmm, xmm, xmm/m64, xmm'     , 'xrmx:   0f 24 1f /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubsd'      , 'W:xmm, xmm/m64, xmm, xmm'     , 'xmrx:   0f 24 1f /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['fnmsubss'      , 'W:xmm, xmm, xmm, xmm/m32'     , 'xxrm:   0f 24 1a /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubss'      , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 1a /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubss'      , 'W:xmm, xmm, xmm/m32, xmm'     , 'xrmx:   0f 24 1e /drex0              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],
  ['fnmsubss'      , 'W:xmm, xmm/m32, xmm, xmm'     , 'xmrx:   0f 24 1e /drex1              ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.OE=M MXCSR.DE=M MXCSR.IE=M'],

  ['frczpd'        , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 11 /r                  ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.DE=M MXCSR.IE=M'],

  ['frczps'        , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 10 /r                  ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.DE=M MXCSR.IE=M'],

  ['frczsd'        , 'W:xmm, xmm/m64'               , 'rm:   0f 7a 13 /r                  ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.DE=M MXCSR.IE=M'],

  ['frczss'        , 'W:xmm, xmm/m32'               , 'rm:   0f 7a 12 /r                  ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.UE=M MXCSR.DE=M MXCSR.IE=M'],

  ['pcmov'         , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 22 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pcmov'         , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 22 /drex1              ' , 'AMD CPUID=SSE5'],
  ['pcmov'         , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 26 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pcmov'         , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 26 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pcomb'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 4c /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomd'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 4e /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomq'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 4f /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomub'        , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 6c /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomud'        , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 6e /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomuq'        , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 6f /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomuw'        , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 6d /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['pcomw'         , 'W:xmm, xmm, xmm/m128, imm8'   , 'xrmi:   0f 25 4d /drex0 ib           ' , 'AMD CPUID=SSE5'],

  ['permpd'        , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 21 /drex0              ' , 'AMD CPUID=SSE5'],
  ['permpd'        , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 21 /drex1              ' , 'AMD CPUID=SSE5'],
  ['permpd'        , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 25 /drex0              ' , 'AMD CPUID=SSE5'],
  ['permpd'        , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 25 /drex1              ' , 'AMD CPUID=SSE5'],

  ['permps'        , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 20 /drex0              ' , 'AMD CPUID=SSE5'],
  ['permps'        , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 20 /drex1              ' , 'AMD CPUID=SSE5'],
  ['permps'        , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 24 /drex0              ' , 'AMD CPUID=SSE5'],
  ['permps'        , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 24 /drex1              ' , 'AMD CPUID=SSE5'],

  ['phaddbd'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 42 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddbq'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 43 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddbw'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 41 /r                  ' , 'AMD CPUID=SSE5'],

  ['phadddq'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 4b /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddubd'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 52 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddubq'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 53 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddubw'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 51 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddudq'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 5b /r                  ' , 'AMD CPUID=SSE5'],

  ['phadduwd'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 56 /r                  ' , 'AMD CPUID=SSE5'],

  ['phadduwq'      , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 57 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddwd'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 46 /r                  ' , 'AMD CPUID=SSE5'],

  ['phaddwq'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 47 /r                  ' , 'AMD CPUID=SSE5'],

  ['phsubbw'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 61 /r                  ' , 'AMD CPUID=SSE5'],

  ['phsubdq'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 63 /r                  ' , 'AMD CPUID=SSE5'],

  ['phsubwd'       , 'W:xmm, xmm/m128'              , 'rm:   0f 7a 62 /r                  ' , 'AMD CPUID=SSE5'],

  ['pmacsdd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 9e /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacsdqh'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 9f /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacsdql'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 97 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacssdd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 8e /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacssdqh'     , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 8f /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacssdql'     , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 87 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacsswd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 86 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacssww'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 85 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacswd'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 96 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmacsww'       , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 95 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmadcsswd'     , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 a6 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pmadcswd'      , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 b6 /drex0              ' , 'AMD CPUID=SSE5'],

  ['pperm'         , 'W:xmm, xmm, xmm, xmm/m128'    , 'xxrm:   0f 24 23 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pperm'         , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 23 /drex1              ' , 'AMD CPUID=SSE5'],
  ['pperm'         , 'W:xmm, xmm, xmm/m128, xmm'    , 'xrmx:   0f 24 27 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pperm'         , 'W:xmm, xmm/m128, xmm, xmm'    , 'xmrx:   0f 24 27 /drex1              ' , 'AMD CPUID=SSE5'],

  ['protb'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 40 /drex0              ' , 'AMD CPUID=SSE5'],
  ['protb'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 40 /drex1              ' , 'AMD CPUID=SSE5'],

  ['protd'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 42 /drex0              ' , 'AMD CPUID=SSE5'],
  ['protd'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 42 /drex1              ' , 'AMD CPUID=SSE5'],

  ['protq'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 43 /drex0              ' , 'AMD CPUID=SSE5'],
  ['protq'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 43 /drex1              ' , 'AMD CPUID=SSE5'],

  ['protw'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 41 /drex0              ' , 'AMD CPUID=SSE5'],
  ['protw'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 41 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshab'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 48 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshab'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 48 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshad'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 4a /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshad'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 4a /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshaq'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 4b /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshaq'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 4b /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshaw'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 49 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshaw'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 49 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshlb'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 44 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshlb'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 44 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshld'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 46 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshld'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 46 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshlq'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 47 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshlq'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 47 /drex1              ' , 'AMD CPUID=SSE5'],

  ['pshlw'         , 'W:xmm, xmm, xmm/m128'         , 'xrm:   0f 24 45 /drex0              ' , 'AMD CPUID=SSE5'],
  ['pshlw'         , 'W:xmm, xmm/m128, xmm'         , 'xmr:   0f 24 45 /drex1              ' , 'AMD CPUID=SSE5'],

  ['ptest'         , 'W:xmm, xmm/m128'              , 'rm:   66 0f 38 17 /r               ' , 'AMD CPUID=SSE5 ZF=U CF=U'],

  ['roundpd'       , 'W:xmm, xmm/m128, imm8'        , 'rmi:   66 0f 3a 09 /r ib            ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.IE=M'],

  ['roundps'       , 'W:xmm, xmm/m128, imm8'        , 'rmi:   66 0f 3a 08 /r ib            ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.IE=M'],

  ['roundsd'       , 'W:xmm, xmm/m64, imm8'         , 'rmi:   66 0f 3a 0b /r ib            ' , 'AMD CPUID=SSE5 MXCSR.PE=M MXCSR.IE=M'],
  ...
  ['vpermil2pd'    , 'W:xmm, xmm, xmm/m128, xmm, is4' , 'rvmi:   vex.nds.128.0f3a.w0 49 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2pd'    , 'W:xmm, xmm, xmm, xmm/m128, is4' , 'rvim:   vex.nds.128.0f3a.w1 49 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2pd'    , 'W:ymm, ymm, ymm/m256, ymm, is4' , 'rvmi:   vex.nds.256.0f3a.w0 49 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2pd'    , 'W:ymm, ymm, ymm, ymm/m256, is4' , 'rvim:   vex.nds.256.0f3a.w1 49 /is4  ' , 'AMD CPUID=XOP'],

  ['vpermil2ps'    , 'W:xmm, xmm, xmm/m128, xmm, is4' , 'rvmi:   vex.nds.128.0f3a.w0 48 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2ps'    , 'W:xmm, xmm, xmm, xmm/m128, is4' , 'rvim:   vex.nds.128.0f3a.w1 48 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2ps'    , 'W:ymm, ymm, ymm/m256, ymm, is4' , 'rvmi:   vex.nds.256.0f3a.w0 48 /is4  ' , 'AMD CPUID=XOP'],
  ['vpermil2ps'    , 'W:ymm, ymm, ymm, ymm/m256, is4' , 'rvim:   vex.nds.256.0f3a.w1 48 /is4  ' , 'AMD CPUID=XOP'],
