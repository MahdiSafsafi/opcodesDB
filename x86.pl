...
@instructions = (
  ...
  ['vpmaskmovd' , 'W:xmm, xmm, m128'       , 'rvm: vex.nds.128.66.0f38.w0 8c /r  '    , 'cpuid=avx2'],
  ...
  ['vpmovqd'   , 'W:xmm/m128 {kz}, xmm'       , 'mr:hvm: evex.128.f3.0f38.w0 35 /r  '    , 'cpuid=avx512f-vl'],
  ['vpmovsqd'  , 'W:xmm/m64 {kz}, xmm'        , 'mr:hvm: evex.128.f3.0f38.w0 25 /r  '    , 'cpuid=avx512f-vl'],
  ['vpmovusqd' , 'W:xmm/m64 {kz}, xmm'        , 'mr:hvm: evex.128.f3.0f38.w0 15 /r  '    , 'cpuid=avx512f-vl'],
  ['vpmovqd'   , 'W:xmm/m128 {kz}, ymm'       , 'mr:hvm: evex.256.f3.0f38.w0 35 /r  '    , 'cpuid=avx512f-vl'],
  ['vpmovsqd'  , 'W:xmm/m128 {kz}, ymm'       , 'mr:hvm: evex.256.f3.0f38.w0 25 /r  '    , 'cpuid=avx512f-vl'],
  ['vpmovusqd' , 'W:xmm/m128 {kz}, ymm'       , 'mr:hvm: evex.256.f3.0f38.w0 15 /r  '    , 'cpuid=avx512f-vl'],
